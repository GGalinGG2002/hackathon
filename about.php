				...
				<div class="row d-flex my-5">
						...
						<div class="col-md-6 wrap ftco-animate">
						  <div class="about-desc">
							...
							<div class="p-5">
							  <h2 class="mb-5">Hi! We are Team Aglet!</h2>
							  <p>This is our first time participating in the SpaceApps Challenge organised by NASA. We are glad to show you our website, which explores satelites in-depth and will help you understand the data they send us, and how that data is used in our day-to-day lives.</p>
				  ...
				  <div class="col-md-10">
					  ...
					  <div class="exp mt-5 ftco-animate">
						  ...
						  <div class="exp-wrap py-4">
							  <div class="desc">
								  <h4>We are classmates!<span> - National Highschool "Elena Cuza" </span> </h4>
								  <p class="location">Romania - Craiova</p>
							  </div>
							  <div class="year">
								  <p>Profile: Mathematics & Informatics</p>
							  </div>
						  </div>
				...
				<div class="col-md-5 text-center">
				  <div class="ftco-footer-widget mb-5">
					<ul class="ftco-footer-social list-unstyled">
					  <li class="ftco-animate"><a href="https://twitter.com/CasapuC"><span class="icon-twitter"></span></a></li>
					  <li class="ftco-animate"><a href="https://www.facebook.com/RaresDorobantuu"><span class="icon-facebook"></span></a></li>
					  <li class="ftco-animate"><a href="https://www.instagram.com/claudiaaa.grosu/"><span class="icon-instagram"></span></a></li>
					</ul>
				  </div>
